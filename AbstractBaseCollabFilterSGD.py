...
class AbstractBaseCollabFilterSGD(object):
    """ Base class for user-movie rating prediction via matrix factorizatio'''
...
class CollabFilterOneVectorPerItem(AbstractBaseCollabFilterSGD):
    ...
    def init_parameter_dict(self, n_users, n_items, train_tuple):
        ...
        * param_dict : dict
        ...
        self.param_dict = dict(
            ...
            c_per_item=ag_np.ones(n_users), # FIX dimensionality
    ...
    def predict(self, user_id_N, item_id_N,
        ...
        for i in range(N):
            ...
            user_bias = b_per_user[user_index]
            item_bias = c_per_item[item_index]
            user_factors = U[user_index]
            item_factors = V[item_index]
            print(ag_np.sum(user_factors * item_factors))
           # yhat = mu + user_bias + item_bias + ag_np.sum(user_factors * item_factors)
